...
class ventana_modificacion_personal extends JDialog{
    ...
    public JPanel panel(){
        ...
        prin.setHorizontalAlignment(SwingConstants.CENTER);
        panel.add(prin);
        ...
        prin2.setHorizontalAlignment(SwingConstants.CENTER);
        panel.add(prin2);
