...
//import Inter_empleado.Interface_Infomesero;


public class Interface_gerentead extends JFrame {
     File archivo;
    ...
    public Interface_gerentead(){
       ...
       // int totalisimo = 0;
        ...
        //PRODUCTOS
        //ptr1 = new Nodo(); parte de estructuras de datos
        //ptr2 = null;
    }
    private void initComponents() {
        ...
        verMenu.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                verMenuMouseMoved(evt);// mostrar leyenda sobre el botón
            }
        });
    ...
    void actualizarImagen() {//Método sin implementación
    }
...
// Comprobar si es mayor que 0 para agregarlos a tabla de pedido
        ...
        Menu.setDefaultCloseOperation(EXIT_ON_CLOSE);//Al cerrar el menú y no volver se cierra todo
    ...
    private void infoMeserosActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        //Interface_Infomesero meserosin =new Interface_Infomesero();
        //this.dispose();
       // Mesero.setDefaultCloseOperation(EXIT_ON_CLOSE);
